...
#ifndef INCLUDED_CUSTOMBLOCKS_PERMUTATION_IMPL_H
#define INCLUDED_CUSTOMBLOCKS_PERMUTATION_IMPL_H

#include <gnuradio/customBlocks/permutation.h>
#include <pmt/pmt.h>
namespace gr {
...
#endif /* INCLUDED_CUSTOMBLOCKS_PERMUTATION_IMPL_H */
